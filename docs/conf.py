...
# -*- coding: utf-8 -*-
#
# hereditary-stratigraph-concept documentation build configuration file, created by
...
project = u'Hereditary Stratigraph Proof of Concept'
...
htmlhelp_basename = 'hereditary-stratigraph-conceptdoc'
...
latex_documents = [
    (master_doc, 'hereditary-stratigraph-concept.tex',
     u'Hereditary Stratigraph Proof of Concept Documentation',
...
man_pages = [
    (master_doc, 'hereditary-stratigraph-concept',
     u'Hereditary Stratigraph Proof of Concept Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hereditary-stratigraph-concept',
     u'Hereditary Stratigraph Proof of Concept Documentation',
     author,
     'hereditary-stratigraph-concept',
