...
As currently stated, strata in eacch column will accumulate proportionally to the length of evolutionary history simulated.
...
The generator method requires a function that takes the current number of strata deposited and yields the set of generations whose should be deleted at that point in time.
...
Strata elimination causes a stratum's positionn withhin the column data structure to no longer correspond to ghe generation it was deposited.
...
This step of truncating to the nearest less than or equal to power of 2 affects our recursive step size is at mmost halved.
